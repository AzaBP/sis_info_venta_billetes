<?php
// Devuelve todos los asientos y su estado para un viaje
...
$stmt = $pdo->prepare('SELECT numero_asiento, estado FROM ASIENTO WHERE id_tren = :id_tren ORDER BY numero_asiento');
