...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav">
            ...
            <a href="billetes.php" data-i18n="billetes">Billetes</a>
            <div class="dropdown">
    ...
    <main class="section-tickets">
        <h2 class="section-title"><i class="fa-solid fa-ticket"></i> <span data-i18n="mis_proximos_viajes">Mis Próximos Viajes</span></h2>
        
        <?php if (!$usuarioSesion): ?>
            <div class="login-banner">
                <i class="fa-solid fa-user-lock fa-3x" style="color: #b6c6d3; margin-bottom: 15px;"></i>
                <h3 data-i18n="login_gestionar_billetes">Inicia sesión para gestionar tus billetes</h3>
                <p style="color: #666; margin-bottom: 20px;" data-i18n="login_gestionar_desc">Si ya has comprado un billete o tienes un abono, entra a tu cuenta para descargarlo o modificarlo.</p>
                <a href="inicio_sesion.html" class="btn-login" style="background: #0a2a66;"><span data-i18n="iniciar_sesion">Iniciar Sesión</span></a>
            </div>
        <?php else: ?>
            <?php if (empty($mis_billetes)): ?>
                <p style="text-align: center; color: #666; padding: 40px; background: #f8f9fa; border-radius: 8px;" data-i18n="no_viajes_programados">No tienes ningún viaje programado actualmente. ¡Usa el buscador para planear tu próxima escapada!</p>
            <?php else: ?>
                    ...
                    ?>
                        <div class="ticket-card" style="opacity: <?= $ya_viajo ? '0.7' : '1' ?>;">
                            ...
                            <div class="ticket-footer">
                                <?php if ($ya_viajo): ?>
                                    <span style="color: #6c757d;" data-i18n="viaje_finalizado">Viaje Finalizado</span>
                                <?php else: ?>
                                    <span data-i18n="localizador">Localizador</span>: #TRN-<?= str_pad($b['id_billete'], 5, '0', STR_PAD_LEFT) ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <h2 class="section-title" style="margin-top: 60px;"><i class="fa-solid fa-circle-info"></i> <span data-i18n="informacion_util">Información Útil</span></h2>
        <div class="info-grid">
            <div class="info-card">
                <i class="fa-solid fa-suitcase fa-2x"></i>
                <h3 data-i18n="equipaje_incluido">Equipaje Incluido</h3>
                <p style="color: #666; font-size: 0.9rem;" data-i18n="equipaje_desc">Todos nuestros billetes incluyen 1 equipaje de mano y 1 maleta de cabina (máx. 10kg). Puedes añadir equipaje extra durante el proceso de compra.</p>
            </div>
            <div class="info-card">
                <i class="fa-solid fa-bolt fa-2x"></i>
                <h3 data-i18n="trenes_avlo_alvia">Trenes AVLO y ALVIA</h3>
                <p style="color: #666; font-size: 0.9rem;" data-i18n="trenes_avlo_desc">Disfruta de la Alta Velocidad Low Cost con nuestros trenes AVLO, o llega a cualquier rincón del país con la comodidad de nuestra flota ALVIA.</p>
            </div>
            <div class="info-card">
                <i class="fa-solid fa-rotate-left fa-2x"></i>
                <h3 data-i18n="cambios_anulaciones">Cambios y Anulaciones</h3>
                <p style="color: #666; font-size: 0.9rem;" data-i18n="cambios_desc">Modifica tu billete hasta 2 horas antes de la salida abonando la diferencia. Cancelaciones gratuitas solo con la tarifa Flex.</p>
            </div>
        </div>
    </main>
